sap.ui.define([
    ...
    return BaseObject.extend("lu.uni.zpositionrequest.model.ListSelector", {
         ...
         * @class
         * @public
         * @alias lu.uni.hcm.model.ListSelector
         */
         ...
         * @return {lu.uni.hcm.model.ListSelector} the list selector object for method chaining
         * @public
         */
