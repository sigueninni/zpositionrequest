		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#luunizpositionrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"luunizpositionrequest-display": {
								"semanticObject": "luunizpositionrequest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lu.uni.zpositionrequest",
									"url": sap.ui.require.toUrl("lu/uni/zpositionrequest")
								}
							}
						}
					}
